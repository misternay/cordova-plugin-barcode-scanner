...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BarcodeScanner",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC14BarcodeScanner28BarcodeScannerViewController")
...
SWIFT_CLASS("_TtC14BarcodeScanner20CameraViewController")
...
@interface CameraViewController (SWIFT_EXTENSION(BarcodeScanner)) <AVCaptureMetadataOutputObjectsDelegate>
...
SWIFT_CLASS("_TtC14BarcodeScanner20HeaderViewController")
...
@interface HeaderViewController (SWIFT_EXTENSION(BarcodeScanner)) <UINavigationBarDelegate>
...
SWIFT_CLASS("_TtC14BarcodeScanner21MessageViewController")
